...
Link a plan file to the active story. Usage: `/claude-control:plan [path]`
...
- List available plan files:
  ...
  ```
- Print the list. Ask the user: "Which plan file should be linked? Re-run with the filename as argument, e.g. `/claude-control:plan docs/superpowers/plans/<filename>`"
- Stop.
